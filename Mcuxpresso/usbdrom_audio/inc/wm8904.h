...
#define WM8904_MICBAIS_ENA						0x0001							/* MICBIAS_ENA */
#define WM8904_MICBAIS_ENA_MASK					0x0001							/* MICBIAS_ENA */
#define WM8904_MICBAIS_ENA_SHIFT					 0							/* MICBIAS_ENA */
#define WM8904_MICBAIS_ENA_WIDTH					 1							/* MICBIAS_ENA */
...
typedef enum {
	DE_EMPH_NONE,		/* 00 = No de-emphasis			*/
	DE_EMPH_32KHZ,		/* 01 = 32kHz sample rate		*/
	DE_EMPH_441KHZ,		/* 10 = 44.1kHz sample rate		*/
	DE_EMPH_48KHZ,		/* 11 = 48kHz sample rate		*/
} WM8904_DE_EMPHASIS_T;
...
void wm8904_adc_vol(uint8_t gain);
