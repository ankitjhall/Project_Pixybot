/*
 * @brief LPC5411x Power library functions
 *
 * @note
...
#ifndef __POWER_LIB_5411X_H_
#define __POWER_LIB_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup POWER_LIBRARY_5411X CHIP: LPC5411X Power LIBRARY functions
 ...
 * @param	freq	: Frequency selection for FRO
 * @return	none
 */
 ...
 * levels that will support the passed CPU frequency.
 */
uint32_t Chip_POWER_SetVoltage(uint32_t desired_freq);

/**
 * @brief	Set low-power voltage levels for LP mode
 * @param   frequency : This is the frequency at which CPU is running.
 * @note    Low power mode is only possible at 12MHz and 48MHz FRO
 * @return	Nothing
 */
