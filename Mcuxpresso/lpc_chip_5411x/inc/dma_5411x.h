/*
 * @brief LPC5411X DMA driver declarations and functions
 *
 * @note
...
#ifndef __DMA_5411X_H
#define __DMA_5411X_H

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup DMALEG_5411X CHIP: LPC5411X DMA Engine driver (legacy)
...
typedef struct {					/*!< DMA channel register structure */
	...
	__IO uint32_t  CTLSTAT;			/*!< DMA Control and status register */
	__IO uint32_t  XFERCFG;			/*!< DMA Transfer configuration register */
	__I  uint32_t  RESERVED;
} LPC_DMA_CHANNEL_T;

/* On LPC540XX, Max DMA channel is 20 */
...
/** @defgroup DMALEG_COMMON_5411X CHIP: LPC5411X DMA Controller driver common functions (legacy)
 * @{
 */
...
/** @defgroup DMALEG_COMMONCHAN_5411X CHIP: LPC5411X DMA Controller driver common channel functions (legacy)
 * @{
 */
...
/** @defgroup DMALEG_CHANNEL_5411X CHIP: LPC5411X DMA Controller driver channel specific functions (legacy)
 * @{
 */
