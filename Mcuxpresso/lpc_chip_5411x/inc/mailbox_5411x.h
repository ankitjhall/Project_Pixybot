/*
 * @brief LPC5411X Mailbox M4/M0+ driver
 *
 * @note
...
#ifndef __MAILBOX_5411X_H_
#define __MAILBOX_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup MAILBOX_5411X CHIP: LPC5411X Mailbox M4/M0+ driver
