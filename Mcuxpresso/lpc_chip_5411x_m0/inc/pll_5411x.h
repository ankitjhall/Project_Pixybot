...
#ifndef __PLL_5411X_H_
#define __PLL_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup PLL_5411X CHIP: LPC5411X PLL Driver
 * @ingroup CHIP_5411X_DRIVERS
 * The PLL in the LPC5411x is flexible, but can be complex to use. This driver
...
typedef enum CHIP_SYSCON_PLLCLKSRC {
	SYSCON_PLLCLKSRC_FRO12MHZ = 0,  /*!< 12MHz FRO */
	...
	SYSCON_PLLCLKSRC_DISABLED = 7   /*!< PLL input clock is disabled */
...
/**
 * @brief	Get the rate of pll from the stored value
 * @return	Current rate of the PLL from the storage
 **/
