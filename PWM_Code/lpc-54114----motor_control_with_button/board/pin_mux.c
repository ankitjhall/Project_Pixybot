...
- {pin_num: '11', pin_signal: PIO0_29/FC1_RXD_SDA_MOSI/SCT0_OUT2/CTIMER0_MAT3/CTIMER0_CAP1/CTIMER0_MAT1/ADC0_0, label: 'J2[5]/D2[1]/P0_29-CT32B0_MAT3-RED', identifier: LED_RED;left_m1}
...
- {pin_num: '15', pin_signal: PIO1_1/SWO/SCT0_OUT4/FC5_SSEL2/FC4_TXD_SCL_MISO/ADC0_4, label: 'J1[15]/P1_1-FC5_SSEL2', identifier: rignt_m1}
...
- {pin_num: '62', pin_signal: PIO1_15/PDM0_CLK/SCT0_OUT5/CTIMER1_CAP3/FC7_CTS_SDA_SSEL0, label: 'J1[17]/P1_15-SCTO5-FC7_CTS', identifier: right_m2}
...
- pin_list:
  - {pin_num: '57', peripheral: SCT0, signal: 'OUT, 7', pin_signal: PIO1_14/FC2_RXD_SDA_MOSI/SCT0_OUT7/FC7_TXD_SCL_MISO_WS, mode: inactive}
  - {pin_num: '15', peripheral: SCT0, signal: 'OUT, 4', pin_signal: PIO1_1/SWO/SCT0_OUT4/FC5_SSEL2/FC4_TXD_SCL_MISO/ADC0_4, mode: inactive}
  - {pin_num: '62', peripheral: SCT0, signal: 'OUT, 5', pin_signal: PIO1_15/PDM0_CLK/SCT0_OUT5/CTIMER1_CAP3/FC7_CTS_SDA_SSEL0, mode: inactive}
...
void BOARD_InitPins_cm4(void)
{
    ...
    GPIO_PinInit(BOARD_left_motor_speeddn_GPIO, BOARD_left_motor_speeddn_PORT, BOARD_left_motor_speeddn_PIN, &left_motor_speeddn_config);

    gpio_pin_config_t left_motor_dir_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_10 (pin 45)  */
    GPIO_PinInit(BOARD_left_motor_dir_GPIO, BOARD_left_motor_dir_PORT, BOARD_left_motor_dir_PIN, &left_motor_dir_config);

    gpio_pin_config_t right_motor_dir_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    ...
    IOCON->PIO[1][14] = ((IOCON->PIO[1][14] &
                          ...
                          * : Inactive.
                          * Inactive (no pull-down/pull-up resistor enabled). */
                         | IOCON_PIO_MODE(PIO114_MODE_INACTIVE)
    ...
    IOCON->PIO[1][15] = ((IOCON->PIO[1][15] &
                          ...
                          * : Inactive.
                          * Inactive (no pull-down/pull-up resistor enabled). */
                         | IOCON_PIO_MODE(PIO115_MODE_INACTIVE)
