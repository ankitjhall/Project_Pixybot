 ...
 * Inactive (no pull-down/pull-up resistor enabled).
 */
#define PIO114_MODE_INACTIVE 0x00u
/*!
 * @brief Select Analog/Digital mode.: Digital mode. */
 ...
 * Inactive (no pull-down/pull-up resistor enabled).
 */
#define PIO115_MODE_INACTIVE 0x00u
/*!
 * @brief Select Analog/Digital mode.: Digital mode. */
...
/*! @name SCT0_OUT4 (number 15), J1[15]/P1_1-FC5_SSEL2
  @{ */
/* @} */

/*! @name SCT0_OUT5 (number 62), J1[17]/P1_15-SCTO5-FC7_CTS
  @{ */
/* @} */
...
/*! @name PIO0_9 (number 44), J2[13]/P0_9-FC2_TXD_SCL_MISO
  @{ */
#define BOARD_left_motor_speeddn_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_left_motor_speeddn_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_left_motor_speeddn_PIN 9U    /*!<@brief 0U pin index: 9 */
                                           /* @} */

/*! @name PIO0_10 (number 45), J2[11]/P0_10-FC2_SCK-CT32B3_MAT0
  @{ */
#define BOARD_left_motor_dir_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_left_motor_dir_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_left_motor_dir_PIN 10U   /*!<@brief 0U pin index: 10 */
                                       /* @} */

/*! @name PIO1_12 (number 51), J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1
  @{ */
#define BOARD_right_motor_dir_GPIO GPIO /*!<@brief GPIO device name: GPIO */
