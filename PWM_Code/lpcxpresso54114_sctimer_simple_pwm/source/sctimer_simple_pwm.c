...
int main(void)
{
    ...
    SCTIMER_UpdatePwmDutycycle(SCT0, DEMO_FIRST_SCTIMER_OUT, 30, eventNumberOutput);
    SCTIMER_UpdatePwmDutycycle(SCT0, DEMO_SECOND_SCTIMER_OUT, 90, eventNumberOutput);
