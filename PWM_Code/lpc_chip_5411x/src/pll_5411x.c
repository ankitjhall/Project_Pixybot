...
#if 0
#define PLL_SSCG1_MF_SET(value)                                     (((unsigned long) (value) << PLL_SSCG1_MF_P) & PLL_SSCG1_MF_M)
#define PLL_SSCG1_MC_SET(value)                                     (((unsigned long) (value) << PLL_SSCG1_MC_P) & PLL_SSCG1_MC_M)
#define PLL_SSCG1_MR_SET(value)                                     (((unsigned long) (value) << PLL_SSCG1_MR_P) & PLL_SSCG1_MR_M)
#endif
