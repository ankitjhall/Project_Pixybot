/*
 * @brief LPC5411X Input Mux Registers and Driver
 *
 * @note
...
#ifndef __INMUX_5411X_H_
#define __INMUX_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup INMUX_5411X CHIP: LPC5411X Input Mux Registers and Driver
 * @ingroup CHIP_5411X_DRIVERS
 * @{
 */

/**
 * @brief LPC5411X Input Mux Register Block Structure
 */
