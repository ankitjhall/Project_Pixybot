/*
 * @brief LPC5411X I2C slave driver
 *
 * @note
...
#ifndef __I2CS_5411X_H_
#define __I2CS_5411X_H_
...
/** @defgroup I2CS_5411X CHIP: LPC5411X I2C slave-only driver
 * @ingroup I2C_5411X
