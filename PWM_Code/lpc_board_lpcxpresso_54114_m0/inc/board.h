/*
 * @brief NXP LPCXpresso LPC54114 board file
 *
 * @note
...
/** @defgroup BOARD_LPCXPRESSO_54114 LPC54114 LPCXpresso LQFP board support software API functions
 * @ingroup LPCOPEN_5410X_BOARD_LPCXPRESSO_54114
 ...
 * <br>
 * @notes:
 * Board Information page: http://www.nxp.com/OM13090
 * Add on board (Mic-Audio-OLED board): http://www.nxp.com/O13089
 * @{
 */

/** @defgroup BOARD_LPCXPRESSO_54114_OPTIONS BOARD: LPC54114 LPCXpresso LQFP board build options
...
/* Board name */
#define BOARD_NXP_LPCXPRESSO_54114
